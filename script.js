...
const QUOTES = [
  "Diese Vorhersage kommt wie ein Elfmeter: kurz, nervenaufreibend, und mit ziemlicher Sicherheit hitzig diskutiert. Trotzdem – wir vertrauen dem Punkt.",
  "22 Spieler laufen gleich 90 Minuten einem Ball hinterher, aber wir haben das Ergebnis schon jetzt. Diese Vorhersage kennt keine Nachspielzeit.",
  "Catenaccio? Diese Vorhersage kennt nur eine Taktik: volle Offensive. Verteidigen überlassen wir gerne der Konkurrenz.",
  "Ein guter Torwart braucht Reflexe, Mut und ein kurzes Gedächtnis. Diese Vorhersage braucht nur Selbstvertrauen – und davon hat sie reichlich.",
  "Die Nachspielzeit ist Fußballs Version von 'Ich bin gleich fertig'. Diese Vorhersage dagegen steht schon lange vor dem Anpfiff felsenfest.",
  "Ein Abseitstor ist wie ein Lottogewinn, den das Finanzamt wieder kassiert. Diese Vorhersage dagegen bleibt garantiert steuerfrei und gültig.",
  "Trainer wechseln öfter als andere Leute ihre Socken. Diese Vorhersage bleibt trotzdem stur bei ihrer Meinung.",
  "Ein Eckball ist die höfliche Art zu sagen: 'Wir haben's versucht.' Diese Vorhersage ist da direkter – sie sagt einfach: Sieg.",
  "Der Schiedsrichter hat immer Recht, besonders wenn er gerade falsch liegt. Diese Vorhersage hat dagegen nie Unrecht – zumindest bis zum Anpfiff.",
  "Ein Freistoß aus 30 Metern ist offizieller Optimismus mit Anlauf. Genau dieser Optimismus steckt auch in dieser Vorhersage.",
  "Die Bank drücken ist auch eine Mannschaftsleistung. Diese Vorhersage dagegen steht von Anfang an in der Startelf.",
  "Ein Eigentor ist der einzige Moment, in dem man sich für die eigene Mannschaft schämt und freut zugleich. Diese Vorhersage soll hoffentlich nur für Freude sorgen.",
  "90 Minuten schreien, dass der Trainer keine Ahnung hat, und danach selbst keinen geraden Pass zustande bringen – so ist Fußball. Diese Vorhersage schreit einfach nur: Sieg.",
  "Der Rasen hat oft mehr Ahnung vom Spiel als mancher Co-Kommentator. Diese Vorhersage hört trotzdem lieber auf ihr Bauchgefühl als auf den Rasen.",
  "Eine Schwalbe fliegt manchmal weiter als ein Distanzschuss. Diese Vorhersage bleibt dagegen schön auf dem Boden der Tatsachen – meistens.",
  "Ein Handspiel im eigenen Sechzehner ist wie ein Fettnäpfchen mit Nachspielzeit. Diese Vorhersage tritt da lieber gar nicht erst rein.",
  "Currywurst schlägt Taktikboard, zumindest in der Halbzeitpause. Diese Vorhersage wurde übrigens auch mit Currywurst-Power berechnet.",
  "Der Videobeweis braucht manchmal länger als eine Ehe. Diese Vorhersage steht dafür sofort und ganz ohne Überprüfung.",
  "Ein Derby ohne Blutgrätsche ist wie Pommes ohne Ketchup. Diese Vorhersage geht trotzdem lieber auf Nummer sicher – mit einem klaren Tipp.",
  "Wer die Meisterschale poliert, hat sie meistens nicht selbst gewonnen. Diese Vorhersage will sich ihren Erfolg dagegen ehrlich verdienen.",
  "Ein Libero ist einfach ein Verteidiger mit Freigang. Diese Vorhersage nimmt sich ebenfalls die Freiheit, einfach mal frech zu tippen.",
  "Die Fankurve stimmt schon Lieder an, bevor überhaupt angepfiffen wird. Diese Vorhersage ist genauso voreilig – aber hoffentlich genauso richtig.",
  "Ein Sturm ohne Chancen ist wie Popcorn ohne Salz. Diese Vorhersage hat sich deshalb für reichlich Würze entschieden.",
  "Manche Trainerentlassungen kommen schneller als der erste Saisonsieg. Diese Vorhersage lässt sich davon zum Glück nicht beirren.",
  "Ein Tiki-Taka ohne Tor ist wie Small Talk ohne Ende. Diese Vorhersage kommt dafür schnell auf den Punkt.",
  "Die 90 Minuten sind vorbei, aber die Diskussion in der Kneipe geht gerade erst los. Diese Vorhersage hat ihre Meinung dazu schon lange vorher abgegeben.",
  "Ein Torwart, der einen Elfmeter hält, ist der Elvis der Nation. Diese Vorhersage würde dafür sofort ein Autogramm holen.",
];
